            ...
            try{
                var channel = newState.member.guild.channels.cache.find(
                    channel =>
                      ...
                      channel.permissionsFor(newState.member.guild.Não me desmute!, eu me silenciei de novo! Isso segura dados para que ele lhe dê uma experiência mais rápida e suave my self again! This safes Data so it gives you a faster and smoother experience")
                  newState.setDeaf(true);
 não poderia enviar informações msg em um
                try{
